    ...
    <Box sx={{ bgcolor: "#0D0D0D", minHeight: "100vh", pb: 10 }}>
      ...
      <Container maxWidth="lg" sx={{ mt: 8 }}>
        <Stack spacing={2} alignItems="center" sx={{ mb: 6, textAlign: "center" }}>
          ...
          <Typography variant="body2" sx={{ color: "#828282", maxWidth: "600px" }}>
            Meet the culinary experts behind our signature dishes, each bringing unique 
            expertise and passion to your plate.
          </Typography>
        </Stack>
        ...
        {loading ? (
          ...
          <Grid container spacing={4} justifyContent="center">
            {items.map((chef) => (
              <Grid key={chef.$id} size={{ xs: 12, sm: 6, md: 3 }} sx={{ display: "flex", justifyContent: "center" }}>
                <ChefCard 
                  name={chef.name} 
